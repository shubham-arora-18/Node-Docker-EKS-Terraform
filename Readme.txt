...
4. How to add istio ingress controller to manage multiple apis deployed on the kubernetes cluster:
   ...
   3. We now instead of defining our kubernetes services type as LoadBalancer/NodePort will define our services type as ClusterIp, this will disable any external interaction with the services. And all the interaction with these services would now go through Istio ingress controller.
